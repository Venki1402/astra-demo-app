...
const analyzeImage = async (imageBase64: string): Promise<string[]> => {
  ...
  const keywords = [
    'landscape', 'portrait', 'abstract', 'nature', 'urban', 'people',
    'architecture', 'animals', 'food', 'technology', 'art', 'beach',
    'mountain', 'forest', 'city', 'night', 'sunset', 'water', 'flowers',
    'vintage', 'black and white', 'colorful', 'minimal', 'texture'
  ];
