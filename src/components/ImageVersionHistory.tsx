...
import { ImageData, getImageVersions, getImageAncestors } from '@/lib/firebase-service';
...
export default function ImageVersionHistory({ imageId, onReprompt }: ImageVersionHistoryProps) {
