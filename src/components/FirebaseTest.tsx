        ...
        {status === 'success' && (
          <Alert className="bg-green-100 border-green-500">
            <AlertDescription>
              ...
              {authDetails && (
                <div className="mt-2">
                  <p><strong>User ID:</strong> {authDetails.uid}</p>
            ...
            <AlertDescription>
              ...
              <div className="mt-2">
                ...
                <ul className="list-disc pl-5">
                  <li>Make sure Google authentication is enabled in your Firebase project</li>
                  <li>Verify that your Firebase configuration is correct</li>
                  <li>Check that "localhost" is in the authorized domains list in Firebase Authentication settings</li>
